    ...
    return(
        ...
        <div className="container mx-auto px-10 2xl:px-0">
          ...
          <div className="text-center xl:mt-20 lg:mt-10 md:mt-6"> 
            ...
            <p className="text-white opacity-60 text-lg 2xl:w-3/12 xl:w-4/12 lg:w-6/12 mx-auto mt-6 leading-relaxed">Sejak 13 tahun saya memulai progamming. Sejak 3 tahun memulai UI design</p>
